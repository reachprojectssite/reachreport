...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-white">
      {/* Enhanced animated background gradient elements - positioned to not cover key content */}
      ...
      <main className="max-w-4xl mx-auto px-4 pt-20 pb-32 relative z-10">
        ...
        {/* Why Join Our Newsletter Section */}
        <div ref={statsRef} className="mt-32 mb-20 relative">
          <h2 className="text-2xl font-bold text-center mb-10">Why Join Our Newsletter?</h2>
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                  ...
                  <div className="mt-4 text-sm">
                    ...
                    <p className="mb-4">
                      WE TAKE REASONABLE STEPS TO PROTECT YOUR PERSONAL INFORMATION. HOWEVER, NO INTERNET OR EMAIL TRANSMISSION IS EVER FULLY SECURE