              ...
              <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto mx-4 sm:mx-auto">
                ...
                <div className="mt-4 space-y-6 text-sm sm:text-base pr-2">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Information We Collect</h3>
                    <p className="uppercase">When you subscribe to the Newsletter, we may collect:</p>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">How We Use Your Information</h3>
                    <p className="uppercase">We use your information to:</p>
                    <ul className="list-disc pl-5 space-y-1 uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Data Usage, Analytics, and Tracking</h3>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Disclosure of Information</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">International Data Transfers and Compliance</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Data Retention</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Your Choices and Unsubscribe</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Third-Party Links</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Security Measures</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Children's Privacy</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Changes to This Privacy Policy</h3>
                    <p className="uppercase">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold uppercase">Contact Us</h3>
                    <p className="uppercase">
                      If you have questions or wish to exercise your rights under this policy, please contact:
                    </p>
                    <p className="font-medium mt-2 uppercase">
